...
/* package rb-vty-0.1.0.0 */
#define VERSION_rb_vty "0.1.0.0"
#define MIN_VERSION_rb_vty(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "rb-vty-0.1.0.0"

#define CURRENT_PACKAGE_KEY "rb-vty-0.1.0.0"
